...
const CardContainer = ({ t2, noToolTip, setBetState,  setDraganRate, setTigerRate, setShowBetSection, setUpdated}:any) => {


  const handleClick = (odd:any) => {
    setBetState &&
        ...
        <div className="card_card_card">
          {t2.map((item:any) => (
            <div className="text-center">
              ...
              <div className={`desk-view-casino ${item?.pnl > 0? "text-success":"text-danger"}`} style={{
                textAlign:"center"
              }}>
              {item?.pnl}
              </div>
